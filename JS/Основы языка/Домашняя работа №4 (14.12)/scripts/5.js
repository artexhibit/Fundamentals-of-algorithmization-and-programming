document.write(`<b>` + "Задание 5:" + `</b><br>`);

let arr3 = [`Книги`, `Фильмы`, `Видео`, undefined, `Контакты`, `Поисковик`, 1, 5, 3, 2];
...
let newArray = arr3.filter(item => { if (item !== undefined) return item; }).sort(compareElements);
