...
const JournalInfo = (props) => (
    <div className="journal__info">
        <div className="journal__info-wrapper">
            ...
            <SmallInput type={props.inputType} name={props.inputType === "date" ? "date" : ""} placeholder={props.inputPlaceholder} autoFocus={false} receiveInputsValue={props.receiveInputsValue} />
        </div>
    </div>
);
